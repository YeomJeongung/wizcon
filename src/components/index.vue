<script setup>
  ...
  const serviceCenterRef = ref(null);
  ...
  const handleScroll = () => {
    ...
    //scroll시
    const refs = [mainRef, overviewRef, servicesRef, serviceCenterRef];
  ...
  const toggleActive = (itemName,event) => {
    ...
    isActive.value = {
      ...Object.fromEntries(Object.entries(isActive.value).map(([key, value]) => [key, key === itemName])),
    };
...
<template>
  ...
  <div class="top-fixed nodrag">
    <div class="logo">
      <div class="flx-row defpd flx-v h100">
        <h1 class="animation-duration-1000 animation-ease-in-out" v-animateonscroll.once="{ enterClass: 'flipleft opacity0', leaveClass: 'fadeout opacity0' }">
        ...
        <ul class="menu flx-row gap3 font1 flx-v w100 flx-c" role="list">
          ...
          <li @click="toggleActive('overview','click')" :class="{ on: isActive.overview }">OVERVIEW</li>
          <li @click="toggleActive('services','click')" :class="{ on: isActive.services }">SERVICES</li>
          <li @click="toggleActive('serviceCenter','click')" :class="{ on: isActive.serviceCenter }">SERVICE CENTER</li>
        </ul>
      </div>
    </div>
  ...
  <div class="h100">
    ...
    <div ref="overviewRef" id="overview" class="box-white">
      <mainPart2 />
    </div>
    <div ref="servicesRef" id="services">
      <mainPart3 />
    </div>
    <div ref="serviceCenterRef" id="serviceCenter" class="box-white">
      <mainPart4 />
    </div>
    <div>
      <mainPart5 />
